...
for years in range(1977,2022):
    year = years
    url = f'https://www.fangraphs.com/leaders.aspx?pos=all&stats=pit&lg=all&qual=0&type=8&season={year}&month=0&season1={year}&ind=0&team=0,ts&rost=0&age=0&filter=&players=0&startdate=&enddate='
...
# save as csv
df.to_csv('fangraph_pitch.csv', index=False)